...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-white selection:bg-black selection:text-white font-sans text-black scroll-smooth relative cursor-none">
      ...
      >
        {/* Top Left Title */}
        <div className="absolute top-12 left-12 z-30 max-w-4xl pointer-events-none">
          <motion.div
          ...
          >
            ...
            <motion.h1 
              ...
              className="text-8xl md:text-[10rem] font-bold uppercase tracking-tighter leading-[0.85] text-black"
            >
              AI <br />
              ARCHITECTURE. <br />
        ...
        {/* Bottom Right UI */}
        <div className="absolute bottom-12 right-12 z-30 flex flex-col items-end space-y-12">
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
      ...
      {/* Manifesto Section */}
      <section className="py-48 border-y border-black/10 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-12 gap-12">
            <div className="col-span-12 lg:col-span-7">
              <div className="monospace-label mb-12">01 // MANIFESTO</div>
              <h2 className="text-7xl md:text-9xl font-bold uppercase tracking-tighter leading-[0.8] mb-12">
                THE FUTURE <br />
                IS <span className="font-sans normal-case tracking-normal">Generative</span>
              </h2>
              <div className="grid grid-cols-2 gap-12 mt-24">
                <div className="border-l border-black/20 pl-8 py-4">
                  <span className="block text-6xl font-bold tracking-tighter">50+</span>
                  <span className="monospace-label">NATIONS.CONNECTED</span>
                </div>
                <div className="border-l border-black/20 pl-8 py-4">
                  <span className="block text-6xl font-bold tracking-tighter">1.2K</span>
                  <span className="monospace-label">ENTRIES.PROCESSED</span>
                </div>
              </div>
            </div>
            <div className="col-span-12 lg:col-span-5 flex flex-col justify-end">
              <div className="p-12 bg-black/5 backdrop-blur-md border border-black/10 rounded-sm">
                ...
                <p className="text-sm text-black/40 leading-relaxed mb-12">
      ...
      {/* Categories - Scattered Asymmetric Layout */}
      <section className="py-48 border-b border-black/10 bg-white relative overflow-hidden min-h-screen">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <div className="mb-32">
            <div className="flex items-baseline space-x-6 mb-4">
              <span className="text-9xl font-bold tracking-tighter leading-none">02</span>
              <h2 className="text-7xl font-bold uppercase tracking-tighter leading-none">CATEGORIES</h2>
            </div>
          ...
          <div className="relative h-[120vh] w-full">
            {CATEGORIES.map((category, idx) => {
              // Define scattered positions based on index
              const positions = [
        ...
        {/* Background Grid for Category Section */}
        <div className="absolute inset-0 hairline-grid opacity-30 pointer-events-none" />
      </section>

      {/* Timeline */}
      <section className="py-48 border-b border-black/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-12 gap-12">
            <div className="col-span-12 lg:col-span-4">
              <div className="monospace-label mb-8">03 // TIMELINE</div>
              <h2 className="text-6xl font-bold uppercase tracking-tighter mb-8">SCHEDULE</h2>
            ...
            <div className="col-span-12 lg:col-span-8">
              <div className="divide-y divide-black/10">
                {KEY_DATES.map((date, idx) => (
                  <div key={idx} className="py-12 flex flex-col sm:flex-row sm:items-center justify-between group cursor-default border-b border-black/5 last:border-0">
                    <div className="flex items-center space-x-12 w-full">
                      <span className="monospace-label text-black/20 group-hover:text-black transition-colors w-12">0{idx + 1}</span>
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between w-full">
                        <h3 className="text-3xl font-bold uppercase tracking-tight group-hover:translate-x-4 transition-transform order-2 sm:order-1">{date.label}</h3>
                        <span className="text-xl font-mono mb-2 sm:mb-0 order-1 sm:order-2 text-black/40 group-hover:text-black transition-colors">{date.date}</span>
                      </div>
                    </div>
                  </div>
                ))}
      ...
      {/* Jury */}
      <section className="py-48 border-b border-black/10 bg-white relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-32 text-center">
            <div className="monospace-label mb-8">04 // THE PANEL</div>
            <h2 className="text-7xl md:text-9xl font-bold uppercase tracking-tighter">JURY</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-black/10 border border-black/10">
            {JURY.map((member: any, idx) => (
              <div key={idx} className="group bg-white p-10 relative overflow-hidden flex flex-col">
                ...
                <div className="mt-10 flex-1 flex flex-col">
                  ...
                  <div className="mt-3 monospace-label text-black/40 leading-relaxed">
                    {member.role}
                  </div>
                  {member.bio && (
      ...
      {/* AI Tools */}
      <section className="py-48 border-b border-black/10 overflow-hidden bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center mb-32">
          <div className="monospace-label mb-8">INTEGRATIONS</div>
          <h2 className="text-6xl font-bold uppercase tracking-tighter">WORKS WITH <br /> <span className="text-black/40">YOUR WORKFLOW</span></h2>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-64 bg-white text-black relative overflow-hidden hairline-grid">
        <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[40rem] font-bold uppercase tracking-tighter leading-none select-none">
            AIAA
          </div>
        </div>
        <div className="mx-auto max-w-5xl px-4 relative z-10 text-center">
          <div className="monospace-label mb-12">FINAL.CALL</div>
          <h2 className="text-8xl font-bold uppercase tracking-[-0.04em] leading-[0.85] sm:text-[12rem]">
            SHAPE THE <br />
            <span className="text-transparent border-text-black" style={{ WebkitTextStroke: '1px black' }}>FUTURE</span>
          </h2>
          <p className="mx-auto mt-16 max-w-2xl text-xl text-black/40 leading-relaxed">
            THE 2026 CALL FOR ENTRIES IS NOW LIVE.
          </p>
          <div className="mt-24 flex flex-col sm:flex-row items-center justify-center gap-12">
            <Link
              to="/submit"
    ...
    <footer className="fixed bottom-0 left-0 w-full z-50 px-12 py-6 flex justify-between items-center pointer-events-none">
